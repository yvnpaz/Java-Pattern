...
public class VehicleDao {
	...
	public List<VehicleRepo> cargarVehicleRepo(Connection connect)
	{
		String sqlAll = "SELECT * FROM VehicleRepo";
		VehicleRepo vehicleRepoSelect = null;
		List<VehicleRepo> listVehicleRepo = new ArrayList<VehicleRepo>();
		...
		try {	
			...
			while (rs.next()) {
				...
				listVehicleRepo.add(vehicleRepoSelect);
			}
		} catch (Exception e) {
			System.out.println("Error en cargar CacheVehicle");
		}
		return listVehicleRepo;
	}
