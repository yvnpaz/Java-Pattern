...
public class ModelDao {
	...
	public List<ModelRepo> cargarModelRepo(Connection connect)
	{
		String sqlAll = "SELECT * FROM ModelRepo";
		ModelRepo modelRepoSelect = null;
		List<ModelRepo> listModelRepo = new ArrayList<ModelRepo>();
		...
		try {	
			...
			while (rs.next()) {
				...
				listModelRepo.add(modelRepoSelect);
			}
		} catch (Exception e) {
			System.out.println("Error en cargar CacheBrand");
		}
		return listModelRepo;
	}
}
