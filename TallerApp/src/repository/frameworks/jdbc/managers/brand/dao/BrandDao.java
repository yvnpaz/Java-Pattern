...
public class BrandDao {
	...
	public List<BrandRepo> cargarBrandRepo(Connection connect)
	{
		String sqlAll = "SELECT * FROM BrandRepo";
		BrandRepo brandRepoSelect = null;
		List<BrandRepo> listBrandRepo = new ArrayList<BrandRepo>();
		...
		try {	
			...
			while (rs.next()) {
				...
				listBrandRepo.add(brandRepoSelect);
			}
		} catch (Exception e) {
			System.out.println("Error en cargar CacheBrand");
		}
		return listBrandRepo;
	}
